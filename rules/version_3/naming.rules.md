...
6. Lifecycle or role suffix: `schema`, `config`, `template`, `manifest`, `report`, `spec`, `mock`, `stub`, `fixture`, `snapshot`, `golden`, `baseline`, `draft`, `archive`, `backup`, `cache`, `index`, `metadata`, `changelog`, `readme`, `license`, `guide`, `tutorial`, `reference`, `api`, `sdk`, `cli`, `plugin`, `extension`, `adapter`, `wrapper`, `handler`, `controller`, `service`, `repository`, `factory`, `builder`, `validator`, `parser`, `serializer`, `encoder`, `decoder`, `transformer`, `converter`, `mapper`, `reducer`, `aggregator`, `filter`, `sorter`, `comparator`, `iterator`, `generator`, `provider`, `consumer`, `producer`, `subscriber`, `publisher`, `listener`, `observer`, `emitter`, `dispatcher`, `router`, `resolver`, `loader`, `fetcher`, `client`, `server`, `proxy`, `gateway`, `middleware`, `interceptor`, `decorator`, `mixin`, `trait`, `interface`, `base`, `core`, `common`, `shared`, `util`, `helper`, `constants`, `types`, `enums`, `models`, `entities`, `dto`, `request`, `response`, `input`, `output`, `params`, `options`, `settings`, `preferences`, `defaults`, `overrides`, `patch`, `diff`, `delta`, `migration`, `seed`, `sample`, `example`, `demo`, `test`, `bench`, `profile`, `trace`, `debug`, `log`, `audit`, `metrics`, `stats`, `health`, `status`, `info`, `error`, `warning`, `summary`, `detail`, `context`, `session`, `transaction`, `lock`, `mutex`, `semaphore`, `barrier`, `timer`, `scheduler`, `executor`, `worker`, `task`, `job`, `process`, `thread`, `promise`, `future`, `callback`, `hook`, `event`, `signal`, `message`, `notification`, `alert`, `trigger`, `action`, `command`, `query`, `mutation`, `subscription`, `broadcast`, `failover`, `fallback`, `retry`, `timeout`, `throttle`, `limit`, `quota`, `budget`, `allocation`, `reservation`, `lease`, `grant`, `claim`, `release`, `cleanup`, `teardown`, `setup`, `init`, `bootstrap`, `startup`, `shutdown`, `restart`, `reload`, `refresh`, `reset`, `checkpoint`, `rollback`, `commit`, `registry`, `binding`, `connection`, `deployment`, `provision`.
7. Extension.
