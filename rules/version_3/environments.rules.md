...
`security.rules.md` (`SSH keys and Git credentials`) owns the key-storage, host-key-verification, and agent-forwarding boundaries; this section covers local agent mechanics only.
